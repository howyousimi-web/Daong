...
export declare class RecaptchaEnterpriseServiceClient {
     ...
     */
    getPolicy(request?: protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest, options?: CallOptions): Promise<[
        protos.google.cloud.recaptchaenterprise.v1.IPolicy,
        protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest | undefined,
        {} | undefined
    ]>;
    getPolicy(request: protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest, options: CallOptions, callback: Callback<protos.google.cloud.recaptchaenterprise.v1.IPolicy, protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest | null | undefined, {} | null | undefined>): void;
    getPolicy(request: protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest, callback: Callback<protos.google.cloud.recaptchaenterprise.v1.IPolicy, protos.google.cloud.recaptchaenterprise.v1.IGetPolicyRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updatePolicy(request?: protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest, options?: CallOptions): Promise<[
        protos.google.cloud.recaptchaenterprise.v1.IPolicy,
        (protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest | undefined),
        {} | undefined
    ]>;
    updatePolicy(request: protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest, options: CallOptions, callback: Callback<protos.google.cloud.recaptchaenterprise.v1.IPolicy, protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest | null | undefined, {} | null | undefined>): void;
    updatePolicy(request: protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest, callback: Callback<protos.google.cloud.recaptchaenterprise.v1.IPolicy, protos.google.cloud.recaptchaenterprise.v1.IUpdatePolicyRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @returns {string} Resource name string.
     */
    policyPath(project: string, key: string): string;
    /**
     ...
     * @returns {string} A string representing the key.
     */
    matchKeyFromPolicyName(policyName: string): string | number;
    /**
