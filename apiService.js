 ...
 * never have to know about URLs, headers, or error codes — they
...
// Change this to your real backend URL when it's ready
const API_BASE_URL = 'https://api.daong.org.ph/api/v1';
...
/* =========================================================
   STATEFUL MOCK "DATABASE" — donations & drives
...
let mockDonationsDb = [
  {
    ...
    checkpoints: [
      ...
      { stage: 'In Transit', loc: 'Checkpoint — San Rafael Junction', time: 'Aug 15, 16:05' },
    ],
  },
  {
    ...
    checkpoints: [
      ...
      { stage: 'In Transit', loc: 'Barangay Sto. Niño Access Rd.', time: 'Aug 14, 13:10' },
      { stage: 'Delivered', loc: 'Barangay Sto. Niño Evac. Center', time: 'Aug 14, 15:45' },
    ],
  },
  {
...
async function request(method, path, body) {
  ...
  try {
    ...
    // Backend not reachable (expected until one is deployed) — fall back to
...
// Public methods used by app.js/pages.js/donations.js — one per backend route
const apiService = {
  TokenStore,
  STAGES,
